...
class T5FineTuner(pl.LightningModule):
    ...
    def train_dataloader(self):
        train_dataset = CustomDataset(tokenizer=self.tokenizer, type_path="PAW_Train_Global",
                                      data_dir=self.hparams.data_dir, max_len=self.hparams.max_seq_length)
    ...
    def val_dataloader(self):
        val_dataset = CustomDataset(tokenizer=self.tokenizer, type_path="PAW_Test_Global",
                                    data_dir=self.hparams.data_dir, max_len=self.hparams.max_seq_length)
